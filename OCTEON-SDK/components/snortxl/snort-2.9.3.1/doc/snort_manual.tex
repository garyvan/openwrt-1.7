...
\title{SNORT\textsuperscript{\textregistered} Users Manual\\2.9.3}
...
\begin{note}
\begin{itemize}
\item Note that you'll need to pass --enable-ipv6 to configure in order obtain IPv6 Event types.
\end{itemize}
\end{note}
