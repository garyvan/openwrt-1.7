...
#define SNORT_CONF_KEYWORD__GRAPH    "graph_path"
...
#define CONFIG_OPT__PORT_TOGGLE                     "port_toggle"
#define CONFIG_OPT__DUAL_BOOT                       "dual_boot"
#endif
...
#ifdef CAV_OCT_HFA
/* port toggling support using -a flag */
void ConfigPort(SnortConfig *, char *);
void ConfigDualBoot(SnortConfig *, char *);
#endif
