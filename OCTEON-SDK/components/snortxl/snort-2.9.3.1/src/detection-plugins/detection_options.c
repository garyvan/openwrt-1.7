...
#ifdef CAV_OCT_SE
// Cavium: RPC is not supported in SE due to missing headers
#define RpcCheckCompare(a,b) 0
#define RpcCheckHash(a) 0
#endif
...
int detection_option_node_evaluate(detection_option_tree_node_t *node, detection_option_eval_data_t *eval_data)
{
    ...
    /* SNORTXL:Reset uri_used once search is done */
    if (eval_data->p->uri_count)
        uri_used = 0;
