...
#define TCP_HZ          100
/* Cavium:Flags to handle stream flushing and session clean up */
#define CAV_FLUSH_NONE              0x00
#define CAV_FLUSH_SSNCLEANCLIENT    0x01
#define CAV_FLUSH_SSNCLEANSERVER    0x02
#define CAV_FLUSH_OVERLAP           0x04
#define CAV_FLUSH_LISTENER          0x08
#define CAV_FLUSH_TALKER            0x10
#define CAV_FLUSH_ALL               0x1F
...
typedef struct _Stream5LWSession
{
    ...
    uint8_t    pending; /* Specifies number of packets to be processed */
    uint32_t   flush_flags; /* Tracks CAV_FLUSH flags */ 
...
void Stream5StopInspection( void * ssnptr, Packet *p, char dir, int32_t bytes,
                    int response);
