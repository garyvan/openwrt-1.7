...
CVMX_SHARED static Stream5Stats St5Stats[CVMX_MAX_CORES +1];
#endif
...
static void Stream5GlobalInit(char *args)
{
    ...
    // Cavium: support for single core stats printing 
    if (cavlast_core())
        memset(St5Stats,0,sizeof(St5Stats));
#endif
...
static void Stream5PrintStats(int exiting)
{
    ...
    // Cavium: support for single core stats printing 
    int i=0;
    St5Stats[cav_oct_core] = s5stats;
    cavbarrier_sync();
    if (cavlast_core())
    {
       memset(&St5Stats[CVMX_MAX_CORES],0,sizeof(Stream5Stats));
       for(i=0;i<CVMX_MAX_CORES;i++)
       {
          St5Stats[CVMX_MAX_CORES].total_tcp_sessions += St5Stats[i].total_tcp_sessions;
          St5Stats[CVMX_MAX_CORES].total_udp_sessions += St5Stats[i].total_udp_sessions;
          St5Stats[CVMX_MAX_CORES].total_icmp_sessions += St5Stats[i].total_icmp_sessions;
          St5Stats[CVMX_MAX_CORES].total_ip_sessions += St5Stats[i].total_ip_sessions;
          St5Stats[CVMX_MAX_CORES].tcp_prunes += St5Stats[i].tcp_prunes;
          St5Stats[CVMX_MAX_CORES].udp_prunes += St5Stats[i].udp_prunes;
          St5Stats[CVMX_MAX_CORES].icmp_prunes += St5Stats[i].icmp_prunes;
          St5Stats[CVMX_MAX_CORES].ip_prunes += St5Stats[i].ip_prunes;
          St5Stats[CVMX_MAX_CORES].tcp_timeouts += St5Stats[i].tcp_timeouts;
          St5Stats[CVMX_MAX_CORES].tcp_streamtrackers_created += St5Stats[i].tcp_streamtrackers_created;
          St5Stats[CVMX_MAX_CORES].tcp_streamtrackers_released += St5Stats[i].tcp_streamtrackers_released;
          St5Stats[CVMX_MAX_CORES].tcp_streamsegs_created += St5Stats[i].tcp_streamsegs_created;
          St5Stats[CVMX_MAX_CORES].tcp_streamsegs_released += St5Stats[i].tcp_streamsegs_released;
          St5Stats[CVMX_MAX_CORES].tcp_rebuilt_packets += St5Stats[i].tcp_rebuilt_packets;
          St5Stats[CVMX_MAX_CORES].tcp_rebuilt_seqs_used += St5Stats[i].tcp_rebuilt_seqs_used;
          St5Stats[CVMX_MAX_CORES].tcp_overlaps += St5Stats[i].tcp_overlaps;
          St5Stats[CVMX_MAX_CORES].tcp_discards += St5Stats[i].tcp_discards;
          St5Stats[CVMX_MAX_CORES].tcp_gaps += St5Stats[i].tcp_gaps;
          St5Stats[CVMX_MAX_CORES].udp_timeouts += St5Stats[i].udp_timeouts;
          St5Stats[CVMX_MAX_CORES].udp_sessions_created += St5Stats[i].udp_sessions_created;
          St5Stats[CVMX_MAX_CORES].udp_sessions_released += St5Stats[i].udp_sessions_released;
          St5Stats[CVMX_MAX_CORES].udp_discards += St5Stats[i].udp_discards;
          St5Stats[CVMX_MAX_CORES].icmp_timeouts += St5Stats[i].icmp_timeouts;
          St5Stats[CVMX_MAX_CORES].icmp_sessions_created += St5Stats[i].icmp_sessions_created;
          St5Stats[CVMX_MAX_CORES].icmp_sessions_released += St5Stats[i].icmp_sessions_released;
          St5Stats[CVMX_MAX_CORES].ip_timeouts += St5Stats[i].ip_timeouts;
          St5Stats[CVMX_MAX_CORES].events += St5Stats[i].events;
          St5Stats[CVMX_MAX_CORES].internalEvents += St5Stats[i].internalEvents;
  
          St5Stats[CVMX_MAX_CORES].tcp_port_filter.dropped += St5Stats[i].tcp_port_filter.dropped;
          St5Stats[CVMX_MAX_CORES].tcp_port_filter.inspected += St5Stats[i].tcp_port_filter.inspected;
          St5Stats[CVMX_MAX_CORES].tcp_port_filter.session_tracked += St5Stats[i].tcp_port_filter.session_tracked;
          St5Stats[CVMX_MAX_CORES].udp_port_filter.dropped += St5Stats[i].udp_port_filter.dropped;
          St5Stats[CVMX_MAX_CORES].udp_port_filter.inspected += St5Stats[i].udp_port_filter.inspected;
          St5Stats[CVMX_MAX_CORES].udp_port_filter.session_tracked += St5Stats[i].udp_port_filter.session_tracked;
       }
#define s5stats St5Stats[CVMX_MAX_CORES]
#endif
