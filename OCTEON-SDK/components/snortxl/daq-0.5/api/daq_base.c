...
#ifdef CAV_OCT_SE
#define dlclose(...) 
#define dlerror()  "Error"
#define dlopen(...) NULL 
#define dlsym(...) NULL

extern char * strdup(const char *s);
static int daq_load_module(const char *filename) __attribute__ ((unused));
#endif

#undef STATIC_MODULE_LIST 
#define STATIC_MODULE_LIST 
...
{
    static const char *extension __attribute__ ((unused));
