...
{
    (u_int8_t *) "BDAT", /* pattern (now in snort content format) */
    0, /* depth */
    0, /* offset */
...
{
    "url", /* type */
    "www.microsoft.com/technet/security/bulletin/ms02-012.mspx" /* value */
};
...
Rule rule13718 = {
   ...
   { 
       ...
       "SMTP BDAT buffer overflow attempt",     /* message */
