...
// pcre:"^Authorization\x3A\s*Basic\s+", dotall, multiline, nocase;
static PCREInfo rule13308pcre2 =
{
    "^Authorization\\x3A\\s*Basic\\s+", /* pattern */
